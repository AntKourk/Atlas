...
var ret=true;
 ...
 function continue_signup() {
	 ...
	 validateName (document.getElementById('company_name').value, 'Επωνυμία');

	 validateName (document.getElementById('doi').value, 'Δ.Ο.Υ.')
	 
	 validateNumber (document.getElementById('afm').value, 9, 'Α.Φ.Μ.');

	 validateNumber (document.getElementById('postal_code').value, 5, 'Τ.Κ.');

	 validateName (document.getElementById('city').value, 'Πόλη');
