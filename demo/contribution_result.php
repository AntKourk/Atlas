...
{
	header('location: contribution_calculator.php');
}
	...
	<div class="service">
	    <div id="main">
			<ul class="breadcrumb">
				...
				<li><a href="contribution_calculator.php">Εργαλείο Υπολογισμού</a></li>
				<li>Αποτέλεσμα Υπολογισμού</li>
			</ul>
	        <div class="side">
			...
			<div class="middle">
				...
				<div id="calculator-panel-content" class= "panel-content">
					<br>
					<div class="line">
						<p>Εισφορές Εργοδότη:</p>
						<div class="output-box">
							<p><?= $employer?></p>
						</div>
					</div>
					<div class="line">
						<p>Εισφορές Εργαζομένου:</p>
						<div class="output-box">
							<p><?= $worker?></p>
						</div>
					</div>
	            ...
	            <button id="confirm" onclick="location.href='contribution_calculator.php'" class="signup"><p>Επιστροφή στο Εργαλείο Υπολογισμού</p></button>
	        </div>
