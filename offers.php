...
<?php include('server/db_search2.php') ?>
<?php
  //session_start();
...
<div class="container">
	...
	<div class="index">
		<div class="index">
	        ...
	        <div class="middle4">
				<?php
					$query = "SELECT job_id,CV,anal_bathmologia,email FROM offers WHERE email = '$email'";
	...
	<div id="footer">
        <ul class="menu_links">
			...
			<li class="menu-2">
                <a href="index2.php" Title>Φορείς</a>
            </li>
			<li class="menu-2">
                <a href="index3.php" Title>Φοιτητή</a>
            </li>
        </ul>
